...
- **Infrastructure:**
  ...
  - [x] Create `.sessions/1/` structure.
  - [x] Store initial source concepts.
  - [x] Create `PROJECT.md`, `REQUIREMENTS.md`, `ROADMAP.md`, `STATE.md`.
  - [x] Create `.planning/templates/task_plan.xml`.
  - [x] Create `AGENTS.md`.
- **Private Workspace:**
  - [x] Create `/.private/jules/persona.yaml`.
